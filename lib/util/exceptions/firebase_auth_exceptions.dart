class FirebaseAuthExceptionMessage implements Exception {
  /// Firebase error code
  final String code;

  /// takes [e.code] thrown by [FirebaseAuthException]
  ///
  /// Use `throw FirebaseAuthExceptionMessage(e.code).message`
  /// to rethrow exception with the human readable message
  FirebaseAuthExceptionMessage(
    this.code,
  );
